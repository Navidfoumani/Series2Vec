...
def graph_ranks(avranks, names, p_values, cd=None, cdmethod=None, lowv=None, highv=None,
                width=12, textspace=1.5, reverse=False, filename=None, labels=False, **kwargs):
    """
...
def draw_cd_diagram(df_perf=None, alpha=0.15, title=None, labels=False):
    """
...
def wilcoxon_holm(alpha=0.05, df_perf=None):
    ...
    k = len(p_values)
    # sort the list in acsending manner of p-valueheight
...
df_perf = pd.read_csv('CNNTran.csv',index_col=False)
